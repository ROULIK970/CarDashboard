      ...
      >
        ...
        >
          <h1 className="p-8 text-2xl text-center">
            The emergence of online sales channels has revolutionized the
            automotive retail landscape, offering consumers greater convenience,
            flexibility, and choice in the vehicle purchasing process. In this
            section, we explore the key trends, strategies, and technologies
            shaping the online sales experience for automotive customers.
            <br />
            <Link to="/sales/dealership">
              <Button className="rounded p-3 hover:bg-gray-200 hover:mt-4 mt-3 hover:text-slate-700">
                {" "}
                Click to Explore Our Dealership insights{" "}
              </Button>
            </Link>
          </h1>
          <div>
