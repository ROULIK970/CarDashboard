  ...
  return (
    <div className="sm:grid sm:grid-cols-12 h-full ">
      ...
      >
        ...
        <div className={`h-full ${dark ? "bg-black text-white" : "bg-blue-100 text-black"}`}>
          <h1 className="p-8  text-2xl text-center">
            Internal Research Content on Autonomous Driving Technology in Car
            Manufacturing: <br />
            <Link to="/research/external">
              <Button className="rounded p-3 hover:bg-gray-200 hover:mt-4 mt-3 hover:text-slate-700">
                {" "}
                Click to Explore Our External insights{" "}
              </Button>
            </Link>
          </h1>
          <div>
            <div className="mb-4 p-6 bg-slate-100 w-[800px] m-auto text-black">
