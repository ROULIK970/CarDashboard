      ...
      >
        ...
        >
          <h1 className="p-8 text-2xl text-center">
            Hardware design plays a pivotal role in shaping the functionality,
            aesthetics, and user experience of automotive systems and
            components. In this section, we explore the latest innovations and
            trends in automotive hardware design, covering key areas such as
            vehicle interfaces, infotainment systems, advanced driver-assistance
            systems (ADAS), and connectivity solutions. <br />
            <Link to="/designing/software">
              <Button className="rounded p-3 hover:bg-gray-200 hover:mt-4 mt-3 hover:text-slate-700">
                {" "}
                Click to Explore Our Software insights{" "}
              </Button>
            </Link>
          </h1>
          <div>
