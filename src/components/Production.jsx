      ...
      >
        ...
        >
          <h1 className="p-8 text-2xl text-center">
            Efficient and optimized production processes are essential for
            automotive manufacturers to meet demand, maintain quality standards,
            and stay competitive in the global market. In this section, we
            explore the latest innovations and best practices in automotive
            production, covering key aspects such as automation, lean
            manufacturing, digitalization, and sustainability. <br />
            <Link to="/manufacturing/material">
              <Button className="rounded p-3 hover:bg-gray-200 hover:mt-4 mt-3 hover:text-slate-700">
                {" "}
                Click to Explore Our Material insights{" "}
              </Button>
            </Link>
          </h1>
          <div>
