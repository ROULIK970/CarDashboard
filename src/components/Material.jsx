      ...
      >
        ...
        >
          <h1 className="p-8 text-2xl text-center">
            Material innovation plays a pivotal role in automotive
            manufacturing, influencing vehicle performance, safety, durability,
            and sustainability. In this section, we delve into the latest
            advancements and trends in automotive materials, highlighting their
            impact on manufacturing processes and the end-user experience.{" "}
            <br />
            <Link to="/manufacturing/production">
              <Button className="rounded p-3 hover:bg-gray-200 hover:mt-4 mt-3 hover:text-slate-700">
                {" "}
                Click to Explore Our Production insights{" "}
              </Button>
            </Link>
          </h1>
          <div>
