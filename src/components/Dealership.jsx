      ...
      >
        ...
        >
          <h1 className="p-8 text-2xl text-center">
            The dealership plays a pivotal role in the automotive sales
            ecosystem, serving as the primary interface between manufacturers
            and consumers. In this section, we delve into the key strategies and
            initiatives aimed at optimizing dealership operations, enhancing
            customer experience, and driving sales performance. <br />
            <Link to="/sales/online">
              <Button className="rounded p-3 hover:bg-gray-200 hover:mt-4 mt-3 hover:text-slate-700">
                {" "}
                Click to Explore Our Online Sales{" "}
              </Button>
            </Link>
          </h1>
          <div>
